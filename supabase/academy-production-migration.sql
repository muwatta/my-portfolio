...
as $$
declare requested_school text := nullif(new.raw_user_meta_data ->> 'school_code', '');
begin
  insert into public.academy_profiles (id, display_name, school_id, state, city, student_level)
